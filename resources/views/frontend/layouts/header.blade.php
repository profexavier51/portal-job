    ...
    <div class="container">
      <div class="main-header">
        <div class="header-left">
          <div class="header-logo"><a class="d-flex" href="index.html"><img alt="agilejobs"
                src="{{ asset('frontend/assets/imgs/template/logoFE.png') }}" width="130" height="110"></a></div>
        </div>
    ...
    <div class="mobile-header-wrapper-inner">
      <div class="mobile-header-content-area">
        <div class="perfect-scroll">
          ...
          <div class="mobile-menu-wrap mobile-header-border">
            ...
            <nav>
              <ul class="mobile-menu font-heading">
                ...
                <li><a href="http://wp.alithemes.com/html/agilejobs/demos/dashboard" target="_blank">Dashboard</a></li>
              </ul>
            </nav>
          </div>
          ...
          <div class="site-copyright">Copyright 2022 &copy; agilejobs. <br>Designed by AliThemes.</div>
        </div>
      </div>
    </div>
  </div>
