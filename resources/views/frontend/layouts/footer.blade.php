<footer class="footer pt-165">
    <div class="container">
      <div class="row justify-content-between">
        <div class="footer-col-1 col-md-3 col-sm-12">
          <a class="footer_logo" href="index.html">
            <img alt="agilejobs" src="assets/imgs/template/logo_2.png">
          </a>
          <div class="mt-20 mb-20 font-xs color-text-paragraph-2">agilejobs is the heart of the design community and the
      ...
      <div class="footer-bottom mt-50">
        <div class="row">
          <div class="col-md-6"><span class="font-xs color-text-paragraph">Copyright &copy; 2023. agilejobs all right
              reserved</span></div>
