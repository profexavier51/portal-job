            ...
            <div class="row">
                <div class="col-12 col-sm-8 offset-sm-2 col-md-6 offset-md-3 col-lg-6 offset-lg-3 col-xl-4 offset-xl-4">
                    <div class="login-brand">
                        <img src="{{ asset('admin/assets/img/logo-agile.jpeg') }}" alt="logo" width="130" style="margin-top: -60px !important" class="shadow-light rounded-circle">
                    </div>
                        ...
                        <div class="card-body" style="margin-top: -30px !important">
                            ...
                            <form method="POST" action="{{ route('admin.password.store') }}">
                                ...
                                <div class="form-group">
                                    ...
                                    <input id="password_confirmation" type="password" class="form-control  {{ $errors->has('password') ? 'is-invalid' : '' }}" name="password_confirmation" tabindex="2" required>
                                    <x-input-error :messages="$errors->get('password_confirmation')" class="mt-2" />
                                </div>
                    ...
                    <div class="simple-footer" style="margin-top: -40px !important; z-index:999; position:relative">
